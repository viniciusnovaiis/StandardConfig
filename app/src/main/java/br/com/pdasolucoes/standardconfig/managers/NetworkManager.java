        ...
        if (view != null) {
            ...
            if (activity.getIntent() != null) {
                if (activity.getIntent().getExtras() != null && activity.getIntent().hasExtra(ConfigurationHelper.ConfigurationEntry.UserCode.getKeyName())) {
                    ...
                    ConfigurationHelper.savePreference(ConfigurationHelper.ConfigurationEntry.UserLeader, activity.getIntent().getExtras().getString(ConfigurationHelper.ConfigurationEntry.UserLeader.getKeyName(), ""));
